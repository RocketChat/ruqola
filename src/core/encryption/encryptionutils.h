...
[[nodiscard]] LIBRUQOLACORE_TESTS_EXPORT QByteArray encodePrivateKey(const QByteArray &privateKey, const QByteArray &masterKey);
[[nodiscard]] LIBRUQOLACORE_TESTS_EXPORT QByteArray decodePrivateKey(const QByteArray &encodedPrivateKey, const QByteArray &masterKey);
